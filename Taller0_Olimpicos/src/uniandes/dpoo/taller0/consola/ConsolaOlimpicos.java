...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Pais de atleta por nombre");
	...
	{
		String nombre_atleta = input("Ingrese el nombre del atleta que le interesa");
		String paisRepresentado = calculadora.paisesEnRango(nombre_atleta);
		System.out.println("El pais representado por: "+ nombre_atleta + " es "+ paisRepresentado );
